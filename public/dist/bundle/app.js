...
var Feed = function (_Component) {
  ...
  _createClass(Feed, [{
    ...
    value: function fetchFeed() {
      ...
      _superagent2.default.get("/instagram/" + this.state.username).query(null).set("Accept", "application/json").end(function (err, response) {
        if (err) {
            ...
            _react2.default.createElement(
              ...
              this.state.feed.map(function (post, i) {
                return _react2.default.createElement(
                  ...
                  _react2.default.createElement("img", { style: { width: 100 + "%" }, src: post.image }),
